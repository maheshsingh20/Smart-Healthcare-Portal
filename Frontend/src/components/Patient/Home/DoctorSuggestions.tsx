...
const DoctorSuggestions = () => {
  const doctors = [
    { name: "Dr. Sneha Kapoor", specialty: "Cardiologist", rating: "4.8" },
    { name: "Dr. A. Sharma", specialty: "Dermatologist", rating: "4.6" },
  ];
            ...
            <div className="flex-1 bg-gradient-to-r from-blue-50/60 via-white/70 to-sky-50/40 dark:from-slate-900/60 dark:via-slate-950/60 dark:to-slate-900/40 rounded-xl border border-blue-100/40 dark:border-slate-800/50 px-6 py-5 transition-all duration-300 hover:scale-[1.01]">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 px-2 py-0.5 rounded-full bg-blue-100/50 dark:bg-blue-900/40">
                    {d.specialty}
                  </span>
                </div>
                <div className="flex items-center gap-1 mt-2 md:mt-0 text-blue-700 dark:text-blue-300 font-medium">
